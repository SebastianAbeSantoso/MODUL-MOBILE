    ...
    init {
        ...
        _listComics.value = listOf(
            ...
            Comic(
                ...
                "When the world was plunged into darkness by the ‘Silent Night’, martial artists gathered to form the Northern Heavenly Sect and restored peace. Years later, betrayal from the mainland destroyed the sect and killed its leader, leaving his son Jin Mu-Won behind to uncover hidden techniques and begin his own journey.",
                "",
                "",
                10),
            Comic(
            ...
            Comic(
                ...
                "I, Maki Maehara, am a class loner. My first friend is Umi Asanagi, the girl everyone calls the “second cutest in class.” I thought someone like me lived in a different world, but through a twist of fate, we soon start hanging out together every Friday after school.",
                "",
                "",
                14),
        )
