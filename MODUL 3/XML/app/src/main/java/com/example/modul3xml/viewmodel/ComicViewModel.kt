...
class ComicViewModel : ViewModel() {
    ...
    val carouselComics: LiveData<List<Comic>> = _carouselComics
    val listComics: LiveData<List<Comic>> = _listComics
    ...
    init {
        _carouselComics.value = listOf(
            Comic(
                ...
                listOf(R.string.genre_romance, R.string.genre_comedy, R.string.genre_transmigration),
            ...
            Comic(
                ...
                listOf(R.string.genre_reincarnation, R.string.genre_time_travel, R.string.genre_action, R.string.genre_romance),
            ...
            Comic(
                ...
                listOf(R.string.genre_psychological, R.string.genre_tragedy, R.string.genre_romance),
                "Yuama", 7
            )
        )
